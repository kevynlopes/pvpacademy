...
export default function config() {
    ...
    const handleSave = () => {
        ...
        axios.post('http://api.pvpacademy.com.br/edit/user', {
            ...
            let data = await JSON.parse(sessionStorage.getItem('@user'))
            ...
            <main>
                <div className={styles.session}>
                    ...
                    <div>
                        ...
                        <h1>E-mail</h1>
                        <input onChange={(c) => setEmail(c.target.value)} placeholder="Insira seu novo e-mail..." />

                        <h1>Senha</h1>
                        <input onChange={(c) => setPass(c.target.value)} placeholder="Insira sua nova senha..." />
