...
export default function ScreenRemAdm() {
    ...
    return (
        <div className={styles.container}>
            ...
            <main>
                ...
                <div className={styles.session}>
                    <div className={styles.painel}>
                        ...
                        <a href="/dashboard/administrator/remadm" className={styles.selected}>Remover administrador</a>

                    </div>
                    <div className={styles.conteudo}>

                        <h1 className={styles.top}>Remover administrador</h1>

                        <h2>CPF</h2>
                        <input onChange={(c) => setCPF(c.target.value)} placeholder="Insira o CPF do administrador..." />
            ...
            {sucess ? <Sucess>Sucesso! Administrador removido da nossa plataforma.</Sucess> : null}
        </div>
    )
}