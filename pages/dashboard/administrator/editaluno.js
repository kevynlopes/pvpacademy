...
export default function ScreenEditAluno() {
    ...
    const [plans, setPlans] = React.useState('basico')
    ...
    return (
        <div className={styles.container}>
            ...
            <main>
                ...
                <div className={styles.session}>
                    <div className={styles.painel}>
                        ...
                        <a href="/dashboard/administrator/editaluno" className={styles.selected}>Editar aluno</a>
                    ...
                    <div className={styles.conteudo}>
                        ...
                        <h1 className={styles.top}>Editar aluno</h1>

                        <h2>CPF</h2>
                        <input onChange={(c) => setCPF(c.target.value)} placeholder="Insira o CPF do cliente..." />
                        
                        <h2>E-mail</h2>
                        <input onChange={(c) => setEmail(c.target.value)} placeholder="Insira o novo e-mail do cliente..." />

                        <h2>Senha</h2>
                        <input onChange={(c) => setPass(c.target.value)} placeholder="Insira a nova senha do cliente..." />

                        <h2>Plano</h2>
                        <select onChange={(c) => setPlans(c.target.value.toLowerCase().replace(/(ç)/g, 'c').replace(/á/g, 'a'))}>
            ...
            {sucess ? <Sucess>Sucesso! Usuário editado em nossa plataforma.</Sucess> : null}
        </div>
    )
}