...
export default function ScreenRemAluno() {
    ...
    return (
        <div className={styles.container}>
            ...
            <main>
                ...
                <div className={styles.session}>
                    <div className={styles.painel}>
                        ...
                        <a href="/dashboard/administrator/remaluno" className={styles.selected}>Remover aluno</a>
                    ...
                    <div className={styles.conteudo}>
                        ...
                        <h1 className={styles.top}>Remover aluno</h1>
            ...
            {sucess ? <Sucess>Usuário removido da plataforma com sucesso.</Sucess> : null}
        </div>
    )
}