            ...
            <main>
                ...
                <div className={styles.session}>
                    ...
                    <div className={styles.conteudo}>
                        ...
                        <h1 className={styles.top}>Adicionar aula</h1>
                        ...
                        <h2>Descrição</h2>
                        <input onChange={(c) => setDescription(c.target.value)} placeholder="Insira a descrição da aula..." />

                        <h2>Aula</h2>
                        <input onChange={(c) => setFile(c.target.files[0])} className={styles.file} id="file" type="file" />

                        <label htmlFor="file">

                            <svg width="36" height="44" viewBox="0 0 36 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 6V38C2 39.0609 2.42143 40.0783 3.17157 40.8284C3.92172 41.5786 4.93913 42 6 42H30C31.0609 42 32.0783 41.5786 32.8284 40.8284C33.5786 40.0783 34 39.0609 34 38V14.684C33.9999 14.1511 33.8934 13.6236 33.6866 13.1325C33.4799 12.6414 33.1771 12.1965 32.796 11.824L23.916 3.14C23.1687 2.40932 22.1651 2.00013 21.12 2H6C4.93913 2 3.92172 2.42143 3.17157 3.17157C2.42143 3.92172 2 4.93913 2 6V6Z" stroke="black" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12 24H24" stroke="black" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12 32H18" stroke="black" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M22 2V10C22 11.0609 22.4214 12.0783 23.1716 12.8284C23.9217 13.5786 24.9391 14 26 14H34" stroke="black" strokeWidth="4" strokeLinejoin="round" />
                            </svg>

                            <h1>Clique  <azul>aqui</azul> para adicionar o arquivo .mp4</h1>
