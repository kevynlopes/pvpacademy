...
export default function ScreenAddAluno() {
    ...
    return (
        <div className={styles.container}>
            ...
            <main>
                ...
                <div className={styles.session}>
                    ...
                    <div className={styles.conteudo}>
                        ...
                        <h1 className={styles.top}>Adicionar aluno</h1>

                        <h2>E-mail</h2>
                        <input onChange={(c) => setEmail(c.target.value)} placeholder="Insira o e-mail do cliente..." />

                        <h2>Senha</h2>
                        <input onChange={(c) => setPass(c.target.value)} placeholder="Insira a senha do cliente..." />

                        <h2>CPF</h2>
                        <input type="tel" onChange={(c) => setCPF(c.target.value)} placeholder="Insira o cpf do cliente..." />

                        <h2>Plano</h2>
                        <select onChange={(c) => setPlan(c.target.value)}>
            ...
            {sucess ? <Sucess>Sucesso! Aluno adicionado, já está disponivel em nosso painel.</Sucess>: null}
        </div>
    )
}