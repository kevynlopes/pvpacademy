    ...
    const auth = () => {
        ...
        axios.post('https://api.pvpacademy.com.br/get/login', {
            ...
            if(res.data.adm === true) {
                ...
                if(res.data.plans.includes('basico')) return router.push(`/dashboard/aulas/1- Introdução básico`)
                if(res.data.plans.includes('avancado')) return router.push(`/dashboard/aulas/1- Introdução avançado`)
                if(res.data.plans.includes('tryhard')) return router.push(`/dashboard/aulas/1- Introdução tryhard`)    
